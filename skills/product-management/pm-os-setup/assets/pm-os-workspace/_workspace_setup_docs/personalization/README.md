...
- What the product or project is, who it is for, and what matters right now.
...
After setup, start using the Chief PM. The workspace should get richer from real notes, outcomes,
decisions, PRDs, design considerations, data insights, roadmaps, stakeholder communications, and skill
updates over time.
