...
If `_setup/` still exists, the workspace is still generic. Tell your agent:

> Customize my workspace.

It will ask a few lightweight questions, personalize the product context and working style, then
delete `_setup/` when it is done.

## How it learns your style

If you want a different format, voice, folder, or workflow, just say so. The agent can update the
workspace skills in [skills/](skills/INDEX.md). Start with
[skills/START_HERE.md](skills/START_HERE.md) to see the base skill set. When a skill changes, the
...
- Put reusable blank formats in [skills/templates/](skills/templates/INDEX.md), such as story,
  feature, epic, meeting summary, PRD, roadmap, or stakeholder update templates.
- Put examples and style samples in [skills/references/](skills/references/INDEX.md), such as how you
