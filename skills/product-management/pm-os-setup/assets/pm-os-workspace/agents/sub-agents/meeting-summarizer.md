...
**My playbook:** [summarize-notes](../../product-practices/skills/summarize-notes.md) is the *how*; I'm the character
...
5. Apply [summarize-notes](../../product-practices/skills/summarize-notes.md) to produce `summary.md` next to
   the `raw/` folder.
